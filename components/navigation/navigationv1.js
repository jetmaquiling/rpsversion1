    ...
    <div className={open ? style.off : style.main}>
      ...
      <div className={style.navbar2}>
        <div className={style.buttonBox}>
          <Link href="/">
            <h4 className={style.h4animate}>Homepage</h4>
          </Link>
        </div>

        <Drawer1
          title="Get Started"
          contents={DrawerContent1}
          drawer={drawer}
          setDrawer={setDrawer}
        />
        ...
        <div className={style.buttonBox}>
          <Link href="/v1/tokenomiks">
            <h4 className={style.h4animate}>Tokenomiks</h4>
          </Link>
        </div>

        <div className={style.buttonBox}>
          <Link href="/v1/initialfundsanduse">
            <h4 className={style.h4animate}>Initial Funds</h4>
          </Link>
        </div>
        ...
        <Drawer1
          title="Setup CryptoWallet"
          contents={DrawerContent4}
          drawer={drawer}
          setDrawer={setDrawer}
        />
      </div>
      <div className={style.rightsBox}>
        <p className={style.rightsText}>
          2021 © RPSAXESS.io | All rights reserved
        </p>
      </div>
    </div>
  );
